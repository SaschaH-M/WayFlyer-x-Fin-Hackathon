  ...
  return (
    <div className="office">
      <div className="stage">
        ...
        {/* plants in two corners + couch (billboarded, sitting on floor at z:0) */}
        <Bill x={-260} y={-260} z={0}><div style={{ fontSize: 30 }}>🪴</div></Bill>
        <Bill x={260} y={-260} z={0}><div style={{ fontSize: 30 }}>🪴</div></Bill>
        <Bill x={260} y={260} z={0}><div style={{ fontSize: 26 }}>🛋️</div></Bill>
